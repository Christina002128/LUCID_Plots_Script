...
p3<-ggplot(detection_data, aes(x = PATIENT)) +
...
p2<-ggplot(detection_data, aes(x = IR, y = plot_IMAF)) +
...
design <- c(
  area(t = 1, l = 1, b = 1, r = 2),  # Plot C (Row 5, spans all columns)
  area(t = 2, l = 1, b = 2, r = 2),   # Plot A (Row 1, spans all columns)
  area(t = 3, l = 1, b = 3, r = 2),   # Plot B (Row 2, spans all columns)
  area(t = 4, l = 1, b = 4, r = 2),   # Plot B (Row 3, spans all columns)
  area(t = 5, l = 1, b = 5, r = 2),  # Plot B (Row 4, spans all columns)
